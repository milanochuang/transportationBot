...
callLIST = ['出來', '你好', '出乃', '哈囉', '不好意思']
byeLIST = ['謝謝', '再見']
PMLIST = ['下午', '傍晚', '晚上', '深夜']
nowLIST = ['現在', '立刻', '立即', '即刻', '此刻']
animalLIST = ['鼠', '牛', '虎', '兔', '龍', '蛇', '馬', '羊', '猴', '雞', '狗', '豬', '貓', '魚', '蜥蜴', '鸚鵡', '鳥']
TaiwanLIST = ['南港', '台北', '板橋', '桃園', '新竹', '苗栗', '台中', '彰化', '雲林', '嘉義', '台南', '左營', '高雄']
AroundLIST = ['附近', '左右', '大約', '大概', '差不多', '前後']
AfterLIST = ['之後', '以後']
BeforeLIST = ['之前','以前']
AdultLIST = ['大人票', '成人票']
FareLIST = ['優待票', '小孩票', '老年票', '老人票', '敬老票']
